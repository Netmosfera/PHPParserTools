 ...
 *
 * @param           Node[] $nodes
 * `Array<Int, Node>` The tree in which the given attribute name is to be searched.
 *
 * @param           String $searchAttribute
 * `String` The attribute name that is to be searched.
 *
 * @return          Bool
 * `Bool` Returns `TRUE` if the provided tree contains the given attribute name.
 */
